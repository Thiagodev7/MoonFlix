...
class FilmeDetalle extends StatelessWidget {
  @override
  ...
  Widget _crearAppbar(Filme filme) {
    return SliverAppBar(
      elevation: 2.0,
  ...
  Widget _posterTitulo(Filme filme, BuildContext context) {
    return Container(
  ...
  Widget _descripcion(Filme filme) {
    return Container(
  ...
  Widget _crearCasting(Filme filme) {
    final peliProvider = new FilmesProvider();

    return FutureBuilder(
      future: peliProvider.getCast(filme.id.toString()),
